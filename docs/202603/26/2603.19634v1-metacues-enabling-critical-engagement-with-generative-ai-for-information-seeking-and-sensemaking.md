...
title_zh: MetaCues：在信息寻求与意义建构中实现与生成式人工智能的批判性互动
...
## 摘要
生成式人工智能（GenAI）搜索工具正越来越多地用于信息寻求，但其设计往往倾向于鼓励认知卸载，这可能导致被动参与、选择性注意以及信息同质化。有效使用这些工具需要元认知参与，以撰写优质提示词、验证 AI 输出并批判性地对待信息。我们开发了 MetaCues，这是一种新型的基于 GenAI 的交互式信息寻求工具，它在提供 AI 响应的同时提供元认知线索和笔记界面，以引导用户的搜索及相关学习。通过一项在线研究（N = 146），我们在两个广泛的搜索主题下将 MetaCues 与没有线索的基准工具进行了比较，这些主题要求参与者探索多元观点以做出明智的判断。关于参与者搜索行为的初步结果显示，MetaCues 提高了参与者对搜索主题态度判断的信心，并促进了更广泛的探究；后者的效果主要体现在争议较小且参与者相对不太熟悉的课题上。据此，我们概述了未来对搜索交互和探究模式进行定性探索的方向。
